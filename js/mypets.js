...
function petCalendarButton(value) {
  var calendarBtn =
    '<button type="button" onclick="window.location.href =\'/calendar.html?petId=' +
    value +
    '\';" class="btn btn-outline-primary">VER   <i class="fas fa-eye"></i></button>';
  return calendarBtn;
}
...
function petTwoBtns(value) {
  var showBtn =
    ...
    value +
    '\';" class="btn btn-outline-green mr-2"><i class="fas fa-eye"></i></button>';
  var editBtn =
    '<button type="button" onclick="window.location.href =\'/update-pet.html?petId=' +
    value +
    '\';" class="btn btn-outline-blue mr-2"><i class="fas fa-pencil-alt"></i></button>';
  var deleteBtn =
    '<button type="button" onclick="window.location.href =\'/my-pets.html?petId=' +
    value +
...
function petThreeBtns(value) {
  ...
  var deleteBtn =
    '<button type="button" onclick="window.location.href =\'/my-patients.html?petId=' +
    value +
    '\';" class="btn btn-outline-red mr-2"><i class="fas fa-trash-alt"></i></button>';
